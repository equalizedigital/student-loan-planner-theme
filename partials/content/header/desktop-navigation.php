<section class="desktop-navigation">
	<nav class="primary-navigation" id="primary-navigation" aria-label="Primary Navigation">
		...
		get_template_part( 'partials/content/header/primary-navigation' ); ?>

		<div class="search-popup" id="search-modal" role="dialog" aria-modal="true">
			<form action="/" method="get">
				<div class="under_line">
					<img src="<?php echo esc_url( get_template_directory_uri() ) . '/assets/icons/utility'; ?>/search-white.svg" alt="search" aria-hidden="true">
			...
			<button class="close" id="close-search">
				<img src="<?php echo esc_url( get_template_directory_uri() ) . '/assets/icons/utility/'; ?>close-cross-white.svg" alt="close search">
			</button>
		</div>
