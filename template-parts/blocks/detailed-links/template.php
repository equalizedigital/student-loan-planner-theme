		...
		<div class="detailed_links_block_container_items">
			...
			if ( have_rows( 'items' ) ) :
				...
				while ( have_rows( 'items' ) ) :
					...
					$detailed_link       = get_sub_field( 'link' );
					$detailed_link_title = get_sub_field( 'title' );
					$copy                = get_sub_field( 'copy' );
					?>
					<a href="<?php echo ! empty( $detailed_link['url'] ) ? esc_url( $detailed_link['url'] ) : '#'; ?>" class="detailed_links_block_container_items_item">
						<div class="detailed_links_block_container_items_item_header">
							<h3 class="title"><?php echo wp_kses_post( $detailed_link_title ); ?></h3>
						</div>
						...
						<div class="detailed_links_block_container_items_item_link">
							...
							<?php echo ! empty( $detailed_link['title'] ) ? esc_html( $detailed_link['title'] ) : 'Learn More'; ?>
							<span class="svg">
