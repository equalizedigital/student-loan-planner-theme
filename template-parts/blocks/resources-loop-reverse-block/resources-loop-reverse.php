<?php
/**
 * Resources Loop Reverse Reverse Block.
 * 
...
$block_id = 'resources-loop-reverse-block-' . $block['id'];
	...
	<div class="resources-loop-reverse-block-container">
		...
		<div class="resources-loop-reverse-block-container-content">
			<div class="resources-loop-reverse-block-container-content-featured">
				<a href="<?php echo esc_url( get_the_permalink( $featured_post->ID ) ); ?>" class="resources-loop-reverse-block-container-content-featured-link">
					<figure>
			...
			<div class="resources-loop-reverse-block-container-content-loop">
				...
				if ( $query->have_posts() ) {
					while ( $query->have_posts() ) {
						...
						?>
							<a class="resources-loop-reverse-block-container-content-loop-item" href="<?php echo esc_url( $post_link ); ?>">
