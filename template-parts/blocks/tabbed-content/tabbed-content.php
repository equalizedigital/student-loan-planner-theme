						...
						foreach ( $rows as $key => $row ) {
							...
							?>
								...
								aria-controls="tab-<?php echo esc_attr( $key ); ?>">
									...
									<div class="text"><?php echo esc_html( $row['tab_title'] ); ?></div>
								</button>
								<?php
								echo '</li>';
						}
						...
						foreach ( $tabbed_content as $key => $row ) {
							...
							<div 
								...
								<span class="tabbed-content__content__text">
									...
									<div class="link">
										<?php if ( ! empty( $tabbed_content_link ) ) : ?>
											<a href="<?php echo esc_url( $tabbed_content_link['url'] ); ?>" class=" btn "><?php echo esc_html( $tabbed_content_link['title'] ); ?></a>
										<?php endif; ?>
									</div>
									<div class="review">
										<?php
										if ( ! empty( $row['rating']['url'] ) ) {
											echo '<a href="' . esc_url( $row['rating']['url'] ) . '">';
										}
										?>
										<?php 
										if ( ! empty( $row['rating']['title'] ) ) {
											echo esc_html( $row['rating']['title'] ); 
										}
										?>
										<?php
										if ( ! empty( $row['rating']['url'] ) ) {
