...
<section id="<?php echo esc_attr($id); ?>" class="<?php echo esc_attr($className); ?> <?php echo $block_style == 'purple'?'media-reviews-block-purple':''; ?>">
    <div class="media-reviews-container">
        ...
        <div class="media-reviews-container-review-items">
			<?php
			if (have_rows('select_reviews')): 
				while (have_rows('select_reviews')): the_row(); 
					...
					<a href="<?php echo esc_url($link); ?>" aria-label="<?php echo $logo['alt']; ?>. <?php echo $stars; ?> out of 5 stars. <?php echo $number_of_reviews; ?> reviews.">
						...
						<div class="rating-stars">
							<span class="star">
								...
								<?php endfor; ?>
								<div class="cover" style="width: calc(<?php echo 100 - ($stars * 17); ?>% + 0px);"></div>
							</span>
								...
								<div class="rating">
									...
									<div class="rating-stars">
										<span class="star">
												...
												<?php endfor; ?>
												<div class="cover" style="width: <?php echo $rating * 10; ?>%;"></div>
										</span>
									</div>
								</div>
							</div>
