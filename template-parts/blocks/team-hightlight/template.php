				...
				while ( have_rows( 'team' ) ) :
					...
					">
						...
						<?php if ( ! empty( $acf_use_alternative_styling ) ) : ?>
							...
							<?php else : ?>
								<button class="team-hightlight-block-container-team-hightlight-member__button modal-btn" data-modal="modal<?php echo esc_html( get_row_index() ); ?>-<?php echo esc_html( $classid ); ?>" aria-label="Open Video">
							<?php endif; ?>
						<?php endif; ?>
							...
							<div class="team-hightlight-block-container-team-hightlight-member__content">
								...
								<?php endif; ?>
								<span class="job"><?php echo wp_kses_post( get_field( 'job_title', $member->ID ) ); ?></span>
							</div>
			...
			<div class="modal-content" >
				...
				<div class="modal_content">
					...
					<div class="modal_text">
						...
						<span class="job">
							<?php echo wp_kses_post( get_field( 'job_title', $member->ID ) ); ?>
						</span>
						<div class="content">
							<?php echo wp_kses_post( wpautop( wp_kses_post( $member->post_content ) ) ); ?>
						</div>
						<?php
						if ( $booking_url ) {
